# -*- coding: utf-8 -*-
"""
Created on Wed Jun  4 17:50:12 2025
...
plt.plot(steps,all_msds,label = 507713)
...
plt.grid()
plt.savefig('MSD507713.pdf')
plt.show()

plt.figure(figsize=(12, 10), dpi=300)   
plt.loglog(steps,all_msds,label = 507713)
plt.title('Log-Log Plot of MSD vs Steps')
plt.legend()
plt.xlabel('Steps')
plt.ylabel('Mean Square Displacement(Simulation Units)')
plt.grid()
plt.savefig('loglogMSD507713.pdf')
plt.show()
